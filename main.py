...
def main(args):
    ...
    with tf.Graph().as_default():
        with tf.Session(config=config) as sess:
            ...
            gst_tx2 ="nvcamerasrc !video/x-raw(memory:NVMM), width=(int)2592, height=(int)1458, format=(string)I420, framerate=(fraction)40/1 ! nvvidconv ! video/x-raw, width=(int)1280, height=(int)720, format=(string)BGRx ! videoconvert ! appsink"
